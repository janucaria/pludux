...
TEST(HmaMethodTest, RunOneMethod)
{
  ...
  const auto period = 5;
  const auto hma_method = HmaMethod{period, field_method};
...
TEST(HmaMethodTest, EqualityOperator)
{
  ...
  const auto period = 5;
  const auto hma_method1 = HmaMethod{period, field_method1};
  const auto hma_method2 = HmaMethod{period, field_method2};
